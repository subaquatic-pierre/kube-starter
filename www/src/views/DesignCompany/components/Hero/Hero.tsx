        ...
        <Box data-aos={isMd ? 'fade-right' : 'fade-up'}>
          ...
          <Box marginBottom={3}>
            <Typography variant="h6" component="p" color="text.secondary">
              World developers use our Blog Template theme to build their web applications.
              <br />
          ...
          <Box display="flex" flexDirection={{ xs: 'column', sm: 'row' }} alignItems={{ xs: 'stretched', sm: 'flex-start' }}>
            ...
            <Box
              ...
              endIcon={
                <Box component={'svg'} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" width={24} height={24}>
                  <path
                    fillRule="evenodd"

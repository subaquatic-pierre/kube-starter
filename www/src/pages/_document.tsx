  ...
  return (
    <Html>
      <Head>
        ...
        <meta property="og:image" content={`${HOST}/images/landingBanner.jpg`} />
        <meta property="og:title" content="Ras Al Khaimah’s First International Forensic Sciences Conference" />
        <meta

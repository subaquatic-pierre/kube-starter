...
function ChatDrawer({
  ...
  const [anchorEl, setAnchorEl] = useState<
    Element | ((element: Element) => Element) | null | any
  >();
    ...
    >
      ...
      >
        ...
        <SimpleBar
          sx={{
            overflowX: 'hidden',
            height: matchDownLG ? 'calc(100vh - 120px)' : 'calc(100vh - 294px)',
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                <Grid item xs zeroMinWidth>
                  <NextLink style={{ all: 'unset' }} href="/profile/personal">
                    {profile && (

...
// types
import { UserCardProps } from 'models/auth';
                ...
                <ListItemAvatar sx={{ mr: 0.75 }}>
                  <Avatar
                    ...
                    src={`/assets/images/users/avatar-${
                      !customer.avatar ? 1 : customer.avatar
                    }.png`}
                  />
                </ListItemAvatar>
                <ListItemText
                  primary={
                    <Typography variant="h5">{customer.fatherName}</Typography>
                  }
                  secondary={
                    <Typography color="secondary">{customer.role}</Typography>
                  }
                />
              </ListItem>
            </List>
                  ...
                  <Grid container spacing={2.25}>
                    <Grid item xs={12}>
                      <MainCard title="About me">
                        <Typography>
                          Hello, Myself {customer.fatherName}, I’m{' '}
                          {customer.role} in international company,{' '}
                          {customer.about}
                        </Typography>
                      </MainCard>
                    </Grid>
